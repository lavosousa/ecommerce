...
CREATE INDEX `fk_addresses_persons_idx` ON `tb_addresses` (`idperson` ASC) -- VISIBLE;    -- TODO dando erro no maria db
...
CREATE INDEX `FK_users_persons_idx` ON `tb_users` (`idperson` ASC) -- VISIBLE;   -- TODO dando erro no maria db
...
CREATE INDEX `FK_carts_users_idx` ON `tb_carts` (`iduser` ASC) -- VISIBLE; -- TODO dando erro no maria db

CREATE INDEX `fk_carts_addresses_idx` ON `tb_carts` (`idaddress` ASC) -- VISIBLE; -- TODO dando erro no maria db
...
CREATE INDEX `FK_cartsproducts_carts_idx` ON `tb_cartsproducts` (`idcart` ASC) -- -VISIBLE;  -- TODO dando erro no maria db

CREATE INDEX `FK_cartsproducts_products_idx` ON `tb_cartsproducts` (`idproduct` ASC) -- VISIBLE;  -- TODO dando erro no maria db
...
CREATE INDEX `FK_orders_carts_idx` ON `tb_orders` (`idcart` ASC) -- VISIBLE;   -- TODO dando erro no maria db

CREATE INDEX `FK_orders_users_idx` ON `tb_orders` (`iduser` ASC) -- VISIBLE;  -- TODO dando erro no maria db

CREATE INDEX `fk_orders_ordersstatus_idx` ON `tb_orders` (`idstatus` ASC) -- VISIBLE;  -- TODO dando erro no maria db
...
CREATE INDEX `fk_productscategories_products_idx` ON `tb_productscategories` (`idproduct` ASC) -- VISIBLE;  -- TODO dando erro no maria db
...
CREATE INDEX `fk_userslogs_users_idx` ON `tb_userslogs` (`iduser` ASC) -- VISIBLE;  -- TODO dando erro no maria db
