<?php if(!class_exists('Rain\Tpl')){exit;}?><form action="https://www.paypal.com/cgi-bin/webscr" method="post">
    ...
    <input type="hidden" name="business" value="gabrielaarend@yahoo.com.br">     <!-- identifica o cliente no pagseguro -->
...
</form>  <!-- No script abaixo pega o unico formulario que tem na tela e manda -->
<script>  
